/*
 * kernel/kern/kern.c — Kernel core initialisation and kernel_main for UNHU
 *
...
void kernel_main(void)
{
    serial_putstr("\r\n");
    serial_putstr("================================================\r\n");
    serial_putstr("  UNHU — U Is Not Hurd, it's µ\r\n");
    serial_putstr("  Mach microkernel — Phase 1\r\n");
    serial_putstr("================================================\r\n");
    serial_putstr("[UNHU] kernel_main entered\r\n");
     ...
     */
    serial_putstr("[UNHU] initialising kernel heap...\r\n");
    kalloc_init();

    serial_putstr("[UNHU] initialising IPC subsystem...\r\n");
    ipc_init();

    serial_putstr("[UNHU] initialising VM subsystem...\r\n");
    vm_init(0, 0);  /* TODO: parse real Multiboot2 memory map */

    serial_putstr("[UNHU] initialising kernel core...\r\n");
    kern_init();

    serial_putstr("[UNHU] all subsystems initialised\r\n");
