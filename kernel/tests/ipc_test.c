/*
 * kernel/tests/ipc_test.c — IPC milestone self-test for NEOMACH (v0.2)
 *
 ...
 *
 * The test is compiled in only when NEOMACH_BOOT_TESTS=ON is set in CMake.
...
int ipc_test_run(void)
{
    serial_putstr("\r\n");
    serial_putstr("========================================\r\n");
    serial_putstr(" NEOMACH IPC Milestone Test (v0.2)\r\n");
    serial_putstr("========================================\r\n");
...
cleanup:
    ...
    if (fail_count == 0) {
        ...
        serial_putstr("========================================\r\n");
        serial_putstr("[NEOMACH] IPC milestone v0.2 PASSED.\r\n");
    } else {
        serial_putstr(" STATUS: FAIL\r\n");
        serial_putstr("========================================\r\n");
        serial_putstr("[NEOMACH] IPC milestone v0.2 FAILED.\r\n");
    }
