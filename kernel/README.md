...
UNHU implements a true microkernel following the original Mach design from
...
The UNHU kernel implements **only** the following subsystems:
...
between UNHU and monolithic kernels such as Linux, and between UNHU and
